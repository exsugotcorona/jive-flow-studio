        ...
        >
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-xl md:text-2xl text-muted-foreground/80 leading-relaxed font-medium">
              Pure happiness! This is what dancing is all about. Turn your
              weekends into memories with Mumbai's liveliest Jive community.
              Step in today-your Social Jive Journey starts here.
            </p>
          </div>
