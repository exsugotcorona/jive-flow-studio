  ...
  const levels = [
    {
      ...
      description: "Perfect for beginners. Learn the fundamental steps, basic timing, and core techniques that form the foundation of jive dancing.",
      duration: "6 weeks",
      skills: [
        "Basic jive steps and timing",
        "Rock step and chasse movements", 
    ...
    },
    {
      ...
      description: "Build on your foundation with more complex moves, improved technique, and better musicality to take your dancing to the next level.",
      duration: "8 weeks",
      skills: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Structured progression designed to take you from your first steps to dance floor mastery
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
          {levels.map((level, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className={`h-full relative overflow-hidden group hover:shadow-[var(--shadow-elegant)] transition-all duration-500 border-border/50 hover:border-primary/30 ${level.color}`}>
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-3">
                    <Badge variant={level.badge as any} className="text-xs font-medium">
                      {level.level}
                    </Badge>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-semibold mb-3 text-foreground">What You'll Master:</h4>
